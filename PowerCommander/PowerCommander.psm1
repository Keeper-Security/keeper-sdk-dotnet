...
Get-KeeperAuditReport, Export-KeeperAuditLog
...
keitree, kein, keiu, keit, keir, keimc, invite-user, lock-user, unlock-user, transfer-user, delete-user, list-team, kar, kal
