...
@{
    ...
    FunctionsToExport    = @('Connect-Keeper', 'Sync-Keeper', 'Disconnect-Keeper', 'Get-KeeperLocation', 'Set-KeeperLocation',
        ...
        'Revoke-KeeperEnterpriseRoleFromTeam', 'New-KeeperEnterpriseRole', 'Remove-KeeperEnterpriseRole',
        #'Test-Keeper',
        ...
        'Export-KeeperVault', 'Export-KeeperMembership', 'Get-KeeperEnterpriseTeams'
    )
