...
@{
    ...
    FunctionsToExport    = @('Connect-Keeper', 'Sync-Keeper', 'Disconnect-Keeper', 'Get-KeeperLocation', 'Set-KeeperLocation',
        ...
        'New-KeeperEnterpriseTeam', 'Update-KeeperEnterpriseTeam', 'Remove-KeeperEnterpriseTeam',
        ...
        'Add-KeeperEnterpriseUserAlias', 'Remove-KeeperEnterpriseUserAlias',
        ...
        'Grant-KeeperRecordAccess', 'Revoke-KeeperRecordAccess', 'Revoke-KeeperSharesWithUser', 'Set-KeeperSharedFolderRecordPermission', 'Grant-KeeperSharedFolderAccess',
        ...
        'Revoke-KeeperSecretManagerFolderAccess', 'Update-KeeperSecretManagerShare', 'Add-KeeperSecretManagerClient', 'Remove-KeeperSecretManagerClient',
        ...
        'New-KeeperNSFFolder', 'New-KeeperNSFFolders', 'Set-KeeperNSFFolderAccess', 'Share-KeeperNSFFolderAccesses', 'Update-KeeperNSFFolderAccesses', 'Unshare-KeeperNSFFolderAccesses', 'Set-KeeperNSFFolder', 'Set-KeeperNSFFolders', 'Remove-KeeperNSFFolder', 'Remove-KeeperNSFFolders', 'Move-KeeperNSFFolder', 'Move-KeeperNSFFolders',
    ...
    AliasesToExport      = @('kc', 'ks', 'kq', 'kpwd', 'kcd', 'kdir', 'ko', 'kr', 'ksf', 'kcc', '2fa', 'kadd', 'kdel', 'kmv', 
        ...
        'nsf-mkdir', 'nsf-mkdirs', 'nsf-share-folder', 'nsf-share-folders', 'nsf-update-folder-access', 'nsf-unshare-folders', 'nsf-rndir', 'nsf-folders-update', 'nsf-rmdir', 'nsf-rmdirs', 'nsf-move-folder', 'nsf-move-folders',
