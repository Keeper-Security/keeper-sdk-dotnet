...
| [Add-KeeperEnterpriseTeamMember](https://docs.keeper.io/en/keeperpam/commander-sdk/keeper-commander-sdks/sdk-command-reference/enterprise-management-commands/enterprise-team-commands#powercommander-4)                          |                  | Add users to team (matches `enterprise-team -au`; supports `-HideSharedFolders`)
| [Remove-KeeperEnterpriseTeamMember](https://docs.keeper.io/en/keeperpam/commander-sdk/keeper-commander-sdks/sdk-command-reference/enterprise-management-commands/enterprise-team-commands#powercommander-4)                       |                  | Remove users from team (matches `enterprise-team -ru`)
| Get-KeeperEnterpriseTeamRole                                                                                          | ketr             | List roles assigned to a team
| Add-KeeperEnterpriseTeamRole                                                                                          |                  | Add role(s) to team (matches `enterprise-team -ar`)
| Remove-KeeperEnterpriseTeamRole                                                                                       |                  | Remove role(s) from team (matches `enterprise-team -rr`)
...
| Get-KeeperEnterpriseUserTeam                                                                                          | keut             | List teams for a user
| Add-KeeperEnterpriseUserTeam                                                                                          |                  | Add team(s) to user (matches `enterprise-user --add-team`; supports `-HideSharedFolders`)
| Remove-KeeperEnterpriseUserTeam                                                                                       |                  | Remove team(s) from user (matches `enterprise-user --remove-team`)
