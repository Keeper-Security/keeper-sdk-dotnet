...
namespace Sample.EnterpriseManagementExamples.EnterpriseRoleExamples
{
    ...
    {
        public static async Task EnterpriseUpdateRole(VaultOnline vault, string roleNameOrId, bool? newUserInherit = null, bool? visibleBelow = null, string displayName = null)
        {
            try
            {
