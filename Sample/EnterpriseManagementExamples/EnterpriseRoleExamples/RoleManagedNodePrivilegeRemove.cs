...
namespace Sample.EnterpriseManagementExamples.EnterpriseRoleExamples
{
    ...
    {
        public static async Task RoleManagedNodePrivilegeRemove(VaultOnline vault, string roleNameOrId, string nodeNameOrId, List<RoleManagedNodePrivilege> privileges)
        {
            try
            {
